        ...
        <main class="col-sm-9 offset-sm-3 col-md-10 offset-md-2 pt-3">
            <section class="row text-center placeholders">
                <div class="col-10 col-sm-12">
                    <form style="padding-top:100px" method="post" action="/index.php/contact/update"
                        ...
                        <div class="form-group">
                            <label>Имя</label>
                            <input type="hidden" name="id" value="<?= $view['contact']->id?>">
                            <input type="text" name="name" placeholder="Имя" class="form-control" value="<?= $view['contact']->name ?>">
                        </div>
                        <div class="form-group">
